...
RangeSlider.prototype = {
  ...
  lock: function() {
    ...
    if (typeof this.box != 'undefined')
      videojs.m(this.box.b, 'locked');
  },
  unlock: function() {
    this.options.locked = false;
    this.ctp.enable();
    if (typeof this.box !='undefined')
      videojs.p(this.box.b, 'locked');
  },
  show:function(){
  ...
  showPanel:function(){
    ...
    if (typeof this.tp !='undefined')
      videojs.p(this.tp.b, 'disable');      
  },
  hidePanel:function(){
    this.options.panel = false;
    if (typeof this.tp !='undefined')
      videojs.m(this.tp.b, 'disable'); 
  },
  ...
  _getArrowValue: function(index) {
    ...
    var percentage = this[index === 0? "left" : "right"].b.style.left.replace("%","");
    if (percentage == "")
  ...
  _reset: function() {
    var duration = this.player.duration();
    this.tpl.b.style.left = '0%';
    this.tpr.b.style.left = '100%';
  ...
  _checkControlTime: function(index,TextInput,timeOld){
    ...
    if (index===1){
      var oldTimeLeft = this.ctpl.b.children,
      ...
      var oldTimeRight = this.ctpr.b.children,
...
videojs.SeekBar.prototype.l.children.RSTimeBar={}; //Range Slider Time Bar
videojs.ControlBar.prototype.l.children.ControlTimePanel={}; //Panel with the time of the range slider
...
videojs.RSTimeBar.prototype.l = {
  children: {
    'SeekRSBar': {}
  }
};

videojs.RSTimeBar.prototype.e = function(){
...
videojs.SeekRSBar.prototype.e = function(){
  return videojs.Component.prototype.e.call(this, 'div', {
...
videojs.SeekRSBar.prototype.onMouseMove = function(event) {
  ...
  var currentTimeDisplay = this.c.controlBar.currentTimeDisplay.b;
  currentTimeDisplay.innerHTML = '<span class="vjs-control-text">Current Time </span>'+videojs.ya(this.rs._seconds(left), this.c.duration());
...
videojs.SeekRSBar.prototype.setPosition = function(index,left,writeControlTime) {
  ...
  // Alias
  var ObjLeft = this.rs.left.b,
    ObjRight = this.rs.right.b,
    Obj = this.rs[index === 0 ? 'left' : 'right'].b,
    tpr = this.rs.tpr.b,
    tpl = this.rs.tpl.b,
    bar = this.rs.bar,
    ctp = this.rs[index === 0 ? 'ctpl' : 'ctpr'].b;
  ...
  if ((index === 0 ?bar.updateLeft(left):bar.updateRight(left))){
    ...
    //-- Panel
    var TimeText = videojs.ya(this.rs._seconds(left)),
      tplTextLegth = tpl.children[0].innerHTML.length;
    var MaxP,MinP,MaxDisP;
    if (tplTextLegth<=4) //0:00
      MaxDisP = this.c.isFullScreen?3.25:6.5;
    else if(tplTextLegth<=5)//00:00
      MaxDisP = this.c.isFullScreen?4:8;
    else//0:00:00
      MaxDisP = this.c.isFullScreen?5:10;
    if(TimeText.length<=4){ //0:00
      MaxP = this.c.isFullScreen?97:93;
      MinP = this.c.isFullScreen?0.1:0.5;
    }else if(TimeText.length<=5){//00:00
      MaxP = this.c.isFullScreen?96:92;
      MinP = this.c.isFullScreen?0.1:0.5;
    }else{//0:00:00
      MaxP = this.c.isFullScreen?95:91;
      MinP = this.c.isFullScreen?0.1:0.5;
    }
...
videojs.SeekRSBar.prototype.getWidth = function() {
  return this.rs.left.b.offsetWidth;//does not matter left or right
};
...
videojs.SelectionBar.prototype.e = function(){
  return videojs.Component.prototype.e.call(this, 'div', {
...
videojs.SelectionBar.prototype.onMouseUp = function(){
  var start = this.rs.left.b.style.left.replace("%",""),
    end = this.rs.right.b.style.left.replace("%",""),
  ...
  this.c.currentTime(segStart);
  this.c.play();
  this.rs.bar.activatePlay(segStart,segEnd);
};

videojs.SelectionBar.prototype.updateLeft = function(left) {
  var rightVal = this.rs.right.b.style.left!=''?this.rs.right.b.style.left:100;
  ...
  if(left <= (right+0.00001)) {
      this.rs.bar.b.style.left = (left * 100) + '%';
      this.rs.bar.b.style.width = (width * 100) + '%';
      return true;
  }
  return false;
};
...
videojs.SelectionBar.prototype.updateRight = function(right) {
  var leftVal = this.rs.left.b.style.left!=''?this.rs.left.b.style.left:0;
  ...
  if((right+0.00001) >= left) {
    this.rs.bar.b.style.width = (width * 100) + '%';
    this.rs.bar.b.style.left = ((right  - width) * 100) + '%';
    return true;
  }
  return false;
};
...
videojs.SelectionBar.prototype.activatePlay = function(start,end){
  ...
  this.c.on("timeupdate", videojs.bind(this,this._processPlay));
};

videojs.SelectionBar.prototype.suspendPlay = function(){
  this.fired = false;
  this.c.off("timeupdate", videojs.bind(this,this._processPlay));
};

videojs.SelectionBar.prototype._processPlay = function (){
  //Check if current time is between start and end
    if(this.c.currentTime() >= this.timeStart && (this.timeEnd < 0 || this.c.currentTime() < this.timeEnd)){
        ...
        this.c.pause(); //Call end function
        this.c.currentTime(this.timeEnd);
        this.suspendPlay();
    }
};
...
videojs.SelectionBarLeft.prototype.e = function(){
  return videojs.Component.prototype.e.call(this, 'div', {
...
videojs.SelectionBarRight.prototype.e = function(){
  return videojs.Component.prototype.e.call(this, 'div', {
...
videojs.TimePanel.prototype.e = function(){
  return videojs.Component.prototype.e.call(this, 'div', {
...
videojs.TimePanelLeft.prototype.e = function(){
  return videojs.Component.prototype.e.call(this, 'div', {
...
videojs.TimePanelRight.prototype.e = function(){
  return videojs.Component.prototype.e.call(this, 'div', {
...
videojs.ControlTimePanel.prototype.l = {
  children: {
...
videojs.ControlTimePanel.prototype.e = function(){
  return videojs.Component.prototype.e.call(this, 'div', {
...
videojs.ControlTimePanel.prototype.enable = function(enable){
  ...
  this.rs.ctpl.b.children[0].disabled = enable?"":"disabled";
  this.rs.ctpl.b.children[1].disabled = enable?"":"disabled";
  this.rs.ctpl.b.children[2].disabled = enable?"":"disabled";
  this.rs.ctpr.b.children[0].disabled = enable?"":"disabled";
  this.rs.ctpr.b.children[1].disabled = enable?"":"disabled";
  this.rs.ctpr.b.children[2].disabled = enable?"":"disabled";
};
...
videojs.ControlTimePanelLeft.prototype.e = function(){
  return videojs.Component.prototype.e.call(this, 'div', {
...
videojs.ControlTimePanelLeft.prototype.onKeyDown = function(event) {
  this.timeOld[0] = this.b.children[0].value;
  this.timeOld[1] = this.b.children[1].value;
  this.timeOld[2] = this.b.children[2].value;
};

videojs.ControlTimePanelLeft.prototype.onKeyUp = function(event) {
  this.rs._checkControlTime(0,this.b.children,this.timeOld);
};
...
videojs.ControlTimePanelRight.prototype.e = function(){
  return videojs.Component.prototype.e.call(this, 'div', {
...
videojs.ControlTimePanelRight.prototype.onKeyUp = function(event) {
  this.rs._checkControlTime(1,this.b.children,this.timeOld);
};
})();
